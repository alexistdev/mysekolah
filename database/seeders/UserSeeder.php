...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user = array(
            ...
            array('role_id'=> 3,'email'=>'guru@gmail.com','password'=> Hash::make('1234'),'created_at' => $date,'updated_at' => $date),
            array('role_id'=> 4,'email'=>'siswa@gmail.com','password'=> Hash::make('1234'),'created_at' => $date,'updated_at' => $date),
        );
        User::insert($user);
    }
}
